...
/*
  ...
  construct_type_b(intersections, 0, links + jylgade_1_east, links + jylgade_2_east, links + jylgade_2_west,
                   links + jylgade_1_west,
                   links + aagade_south, links + aagade_north, links + jylgade_1_east_plusbus,
                   links + jylgade_2_east_plusbus,
  ...
  construct_type_b(intersections + 1, 1, links + jylgade_2_east, links + jylgade_3_east, links + jylgade_3_west,
                   links + jylgade_2_west, links + niels_ebbesens_gade_south, links + niels_ebbesens_gade_north,
                   links + jylgade_2_east_plusbus,
  ...
  construct_type_c(intersections + 2, 2, links + jylgade_3_east, links + jylgade_4_east, links + jylgade_4_west,
                   links + jylgade_3_west,
                   links + dag_ham_gade_1_north, links + dag_ham_gade_2_north, links + dag_ham_gade_2_south,
                   links + dag_ham_gade_1_south,
                   links + jylgade_3_east_plusbus, links + jylgade_4_east_plusbus, links + jylgade_4_west_plusbus,
                   links + jylgade_3_west_plusbus);
  ...
  construct_type_c(intersections + 3, 3, links + jylgade_4_east, links + fyensgade_east, links + fyensgade_west,
                   links + jylgade_4_west,
                   links + sdrbro_north, links + kjellerupsgade_north, links + kjellerupsgade_south,
                   links + sdrbro_south,
                   links + jylgade_4_east_plusbus, links + fyensgade_east_plusbus, links + fyensgade_west_plusbus,
                   links + jylgade_4_west_plusbus);
  ...
  construct_type_d(intersections + 4, 4, links + fyensgade_east, links + karolinelundsvej_north,
                   links + karolinelundsvej_south, links + fyensgade_west,
                   links + bornholmsgade_1_north, links + bornholmsgade_1_south, links + fyensgade_east_plusbus,
                   links + fyensgade_west_plusbus);
  ...
  construct_type_a(intersections + 5, 5, links + bornholmsgade_1_south, links + bornholmsgade_2_south,
                   links + bornholmsgade_2_north, links + bornholmsgade_1_north,
                   links + faerogade_1_east, links + faereogade_2_east, links + faereogade_2_west,
                   links + faereogade_1_west);
  ...
  construct_type_a(intersections + 6, 6, links + bornholmsgade_2_south, links + bornholmsgade_3_south,
                   links + bornholmsgade_3_north, links + bornholmsgade_2_north,
                   links + sjaelgade_1_east, links + sjaelgade_2_east, links + sjaelgade_2_west,
                   links + sjaelgade_1_west);
  ...
  construct_type_e(intersections + 7, 7, links + oester_alle_1_east, links + oester_alle_2_east,
                   links + oester_alle_2_west, links + oester_alle_1_west,
                   links + sghsvej_1_north, links + sghsvej_1_south, links + sghsvej_1_north_plusbus,
                   links + bornholmsgade_3_north,
  ...
  construct_type_c(intersections + 8, 8, links + sghsvej_1_south, links + sghsvej_2_south, links + sghsvej_2_north,
                   links + sghsvej_1_north,
                   links + kridtsleofen_east, links + bernstorffsgade_east, links + bernstorffsgade_west,
                   links + kridtsleofen_west,
                   links + sghsvej_1_south_plusbus, links + sghsvej_2_south_plusbus, links + sghsvej_2_north_plusbus,
                   links + sghsvej_1_north_plusbus);
...
link* right_turn(intersection *intersection, int link_id) {
  ...
  switch (intersection->type) {
    case 'a' :
      result = intersection->layout.type_a.links[(internal_index(intersection, link_id) + RIGHT) % 8];
      break;

    case 'b' :
      result = intersection->layout.type_b.links[(internal_index(intersection, link_id) + RIGHT) % 8];
      break;

    case 'c' :
      result = intersection->layout.type_c.links[(internal_index(intersection, link_id) + RIGHT) % 8];
      break;

    case 'd' :
      result = intersection->layout.type_d.links[(internal_index(intersection, link_id) + RIGHT) % 8];
      break;

    case 'e' :
      result = intersection->layout.type_e.links[(internal_index(intersection, link_id) + RIGHT) % 8];
      break;
    default:
      exit(EXIT_FAILURE);
      break;
...
link* left_turn(intersection *intersection, int link_id) {
  ...
  switch (intersection->type) {
    case 'a' :
      result = intersection->layout.type_a.links[(internal_index(intersection, link_id) + LEFT) % 8];
      break;

    case 'b' :
      result = intersection->layout.type_b.links[(internal_index(intersection, link_id) + LEFT) % 8];
      break;

    case 'c' :
      result = intersection->layout.type_c.links[(internal_index(intersection, link_id) + LEFT) % 8];
      break;

    case 'd' :
      result = intersection->layout.type_d.links[(internal_index(intersection, link_id) + LEFT) % 8];
      break;

    case 'e' :
      result = intersection->layout.type_e.links[(internal_index(intersection, link_id) + LEFT) % 8];
      break;
    default:
      exit(EXIT_FAILURE);
      break;
...
link* go_forward(intersection *intersection, int link_id) {
  ...
  switch (intersection->type) {
    case 'a':
      result = intersection->layout.type_a.links[(internal_index(intersection, link_id) + FORWARD) % 8];
      break;

    case 'b' :
      result = intersection->layout.type_b.links[(internal_index(intersection, link_id) + FORWARD) % 8];
      break;

    case 'c' :
      result = intersection->layout.type_c.links[(internal_index(intersection, link_id) + FORWARD) % 8];
      break;

    case 'd' :
      result = intersection->layout.type_d.links[(internal_index(intersection, link_id) + FORWARD) % 8];
      break;
...
link* plusbus_dec(intersection *intersection, int link_id) {
  ...
  switch (intersection->type) {
    case 'a' :
      result = intersection->layout.type_a.links[((internal_index(intersection, link_id) == 0) ? 3 : 7)];
      break;

    case 'b' :
      result = intersection->layout.type_b.links[(internal_index(intersection, link_id) + 1)];
      break;

    case 'c' :
      result = intersection->layout.type_c.links[(internal_index(intersection, link_id) + 1)];
      break;

    case 'd' :
      result = intersection->layout.type_c.links[(internal_index(intersection, link_id) + 3) % 8];
      break;
...
link* turn(turn_dir dir, intersection *intersection, int link_id) {
  ...
  switch (dir) {
    case left:
      result = left_turn(intersection, link_id);
      break;
    case right:
      result = right_turn(intersection, link_id);
      break;
    case forward:
      result = go_forward(intersection, link_id);
      break;
    case plusbus:
      result = plusbus_dec(intersection, link_id);
      break;
  }
  return result;
}
