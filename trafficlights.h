...
void intersection_traffic_lights_type_c(vehicle *vehicle, link *link, int pb_e1, int pb_e2,int l_e1,int l_e2,int l_e3,int l_e4);
/*Controls traffic lights of type d intersections*/
void intersection_traffic_lights_type_d(vehicle *vehicle, link *link, int pb_e, int l_e1, int l_e2, int l_e3);
/*Controls traffic lights of type e intersections*/
void intersection_traffic_lights_type_e(vehicle *vehicle, link *link, int pb_e, int l_e1,int l_e2,int l_e3,int l_e4);